        ...
        <>
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead className="text-xs text-gray-700 uppercase bg-slate-200 dark:bg-gray-700 dark:text-gray-400 border border-gray-600 border-b-2">
                    <tr>
                        <th scope="col" className="px-2 py-1 border border-gray-400">
                            Item Name
                        </th>
                        <th scope="col" className="px-2 py-1 border border-gray-400">
                            Image
                ...
                <tbody className="bg-slate-100">
                    {items.map(transactItem => (
                        <tr key={transactionId + "_" + transactItem.item._id} className="border-b border-gray-800">
                            <td scope="row" className="px-2 py-2 border border-gray-400 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {transactItem.item.name}
                            </td>
                            <td scope="row" className="px-2 py-2 border border-gray-400">
                            ...
                            <td scope="row" className="px-2 py-2 border border-gray-400 text-center">
                                {transactItem.quantity}
                            </td>
                            <td scope="row" className="px-2 py-2 border border-gray-400 text-center">
                                {transactItem.returnQuantity}
                            </td>
                            <td scope="row" className="px-2 py-2 border border-gray-400">
