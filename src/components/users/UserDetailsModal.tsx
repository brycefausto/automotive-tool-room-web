      ...
      <Modal.Body>
        <div className="grid grid-cols-2 gap-4 mb-2">
          <div>
            ...
            <p><span className="font-bold">Role:</span> {capitalizeWords(user.role)}</p>
            ...
            {[UserRole.PROFESSOR, UserRole.GUEST].includes(user.role) && (
              <p><span className="font-bold">Department:</span> {user.department?.name}</p>
            )}
