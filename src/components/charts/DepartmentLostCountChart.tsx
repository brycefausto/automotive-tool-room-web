...
const options = {
  ...
  plugins: {
    ...
    title: {
      display: true,
      text: 'Missing/Broken Items Count by Department Chart',
    },
  },
};

const labels = ['Missing/Broken Count'];

export default function DepartmentLostCountChart() {
  const { data, isLoading, error } = useDataFetch<any[]>('/reports/departments-lost-items')
